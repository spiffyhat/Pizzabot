...
module.exports = {
    data: new SlashCommandBuilder()
        .setName('pizza')
        .setDescription('Replies with pizza (hopefully)'),
    async execute(interaction) {
        await interaction.reply('What do I look like to you, a functioning program? It\'s ' + new Date().getFullYear() + ', everything is in early access kid!');
    }
}
